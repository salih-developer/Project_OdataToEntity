...
namespace OdataToEntity.EfCore
{
    public class OeEfCoreEdmModelMetadataProvider : OeEdmModelMetadataProvider
    {
        ...
        {
            foreach (Microsoft.EntityFrameworkCore.Metadata.RuntimeEntityType efEntityType in GetEntityTypes(principalNavigation))
            {
                RuntimeNavigation navigation = efEntityType.FindNavigation(principalNavigation.Name);
                if (navigation != null)
                {
